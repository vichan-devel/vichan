...
const submit = $("<input type='button' value='"+_("Update custom CSS")+"'>").css({
  position: "absolute",
  height: 25, bottom: 5,
  width: "calc(100% - 10px)",
  left: 5, right: 5
...
const apply_css = () => {
  document.querySelector('.user-css').remove();
  $('link[rel="stylesheet"]')
    .last()
    .after(document.querySelector('<style></style>')
      .classList.add('user-css')
