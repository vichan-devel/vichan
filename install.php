...
';
	...
	$page['body'] = '<p style="text-align:center">Thank you for using NPFchan. Please remember to report any bugs you discover. <a href="https://github.com/fallenPineapple/NPFchan/wiki/Configuration">How do I edit the config files?</a></p>';
